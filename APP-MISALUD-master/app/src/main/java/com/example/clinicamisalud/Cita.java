...
public class Cita extends AppCompatActivity {
    ...
    int idEspecial,idMedic,idProced,idExpediente2;
    String fecha,horaInicio,horaFin,observaciones,nombrepaciente;
...
//termina lo del calendario
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle bundle = getIntent().getExtras();
         nombrepaciente = bundle.getString("paciente");
      ...
      //  String namePaciente=name.replaceAll(" ","%20");
        ...
        String consulta =("https://apiapp.misalud.com.sv/citas/buscar_pacientes?user="+usuario+"&pass="+contraseña+"&text=");
        ...
        spEspecialidad.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long l) {
                ...
                // Solo para volver a verificar id del paciente.
                String consulta =("https://apiapp.misalud.com.sv/citas/buscar_pacientes?user="+usuario+"&pass="+contraseña+"&text=");
                RecibirExpediente(consulta);
...
// agregar metodo para fecha.
    ...
    public void CargarExpediente(JSONArray je){
        ...
        for(int i=0;i<je.length();i+=4){
            try {
                if(nombrepaciente.equals(je.getString(i+4))) {
                    String expediente = je.getString(i+2);
                    idExpediente2 = Integer.parseInt(expediente);
                }
                lista.add(je.getString(i+2)+je.getString(i+4));
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
